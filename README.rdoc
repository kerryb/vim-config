...
TextMate-style snippets for Vim (more[http://www.vim.org/scripts/script.php?script_id=2540])
...
Also added scala.snippets[http://github.com/tommorris/scala-vim-snippets].

*Keybindings*

Changed trigger key to shift-tab from the default tab, to avoid triggering unexpectedly when trying to use tab completion.
