" Vim color file
" Converted from Textmate theme Mac Classic using Coloration v0.2.1 (http://github.com/sickill/coloration)
...
hi Visual  guifg=NONE guibg=#ffd600 gui=NONE
...
hi PmenuSel  guifg=NONE guibg=#ffd600 gui=NONE
